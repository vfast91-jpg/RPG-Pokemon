...
const MOVE_PACKS: Array[String] = [
    "res://data/gen1_moves_runtime_v3_27_1_families_21_30.json", "res://data/gen1_moves_runtime_v3_27_2_families_21_30.json", "res://data/gen1_moves_runtime_v3_27_3_families_21_30.json", "res://data/gen1_moves_runtime_v3_27_4_families_21_30.json"
]
const EXPECTED_MOVE_IDS: Array[String] = [
    "aqua_ring", "aurora_beam", "brine", "dive", "ice_shard", "icicle_spear", "sheer_cold", "triple_axel", "poison_gas", "sludge", "minimize", "memento", "razor_shell", "icicle_crash", "lick", "mean_look", "shadow_punch", "destiny_bond", "poltergeist", "phantom_force", "ancient_power", "head_smash", "hammer_arm", "wide_guard", "flail", "slam", "crabhammer", "guillotine", "hail", "counter", "final_gambit", "wood_hammer", "bonemerang", "skull_bash"
]
...
func _init() -> void:
    ...
    if not pvp_top.contains('extends "res://scripts/battle_demo_families_21_30_runtime_v1.gd"'):
    ...
    if failures.is_empty():
        print("Familien 21-30 Attackenblock V20: OK (34 Definitionen)")
        quit(0)
        return

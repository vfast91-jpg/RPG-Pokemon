...
const EFFECTS: Dictionary = {
    ...
    "db_charge": {"player_label":"Ladevorgang","runtime_state":IMPLEMENTED,"persistent":true,"tooltip":true,"detail":true,"status_card":true,"required_fields":["duration_actions"]},

...
# One registry entry is the contract between attack data, runtime and every player-facing surface.
...
const STATUSES: Dictionary = {
    ...
    "bad_poison": {"player_label": "Schwere Vergiftung", "runtime_state": PARTIAL},

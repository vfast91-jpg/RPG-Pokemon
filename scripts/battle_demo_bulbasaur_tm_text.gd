...
const BULBASAUR_TM_SUMMARIES: Dictionary = {
    ...
    "endure": "bis zu 3 eigene Aktionen: erste sonst tödliche Feindattacke lässt 1 KP und verbraucht Ausdauer · indirekter/eigener Schaden wirkt",
    ...
    "helping_hand": "Verbündeter: Angriff stark ↑ (Statuswert) · 3 Aktionen · nicht auf sich selbst",
